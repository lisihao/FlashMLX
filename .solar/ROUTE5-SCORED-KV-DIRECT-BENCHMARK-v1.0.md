...
> 版本: v1.0 | 模型: Qwen3-8B-MLX-4bit | 平台: M4 Pro 48GB
> 测试日期: 2026-03-31
...
> 注: v0.9.0 数据来自 M4 Pro 48GB，v1.0 数据同样来自 M4 Pro 48GB。
...
*Model: Qwen3-8B-MLX-4bit | Hardware: Apple M4 Pro 48GB | Date: 2026-03-31*
