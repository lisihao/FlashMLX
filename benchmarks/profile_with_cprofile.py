#!/usr/bin/env python3
"""
Deep profiling with Python cProfile to see function call overhead
"""
...
def main():
    print("=" * 80)
    print("Python cProfile - Deep Function Analysis")
    print("=" * 80)
    print()
    ...
    print()
    print("=" * 80)
    print("CALLERS of key MLX functions")
    print("=" * 80)
    print()

    # Find MLX-related functions
    mlx_functions = [
        'concatenate',
        'rms_norm',
        'matmul',
    ...
    for func_name in mlx_functions:
    ...
    json_file = OUTPUT_DIR / "cprofile_stats.json"
